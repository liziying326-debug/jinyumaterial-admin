        ...
        <nav className="flex-1 overflow-y-auto py-6">
          ...
          <ul className="space-y-1 px-3">
            ...
            <li className="pt-4 mt-4 border-t border-gray-100">
              ...
              >
                <UserCog className={`w-5 h-5 mr-3 ${activeTab === 'account' ? 'text-blue-600' : 'text-gray-400'}`} />
                账号管理
              </button>
            </li>
          </ul>
          ...
          <div className="flex items-center text-gray-500">
            ...
            <div className="relative" ref={searchRef}>
              ...
              <input 
                ...
                className="pl-10 pr-9 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all w-72"
              />
              {searchQuery && (
                <button 
              ...
              {showSearch && searchQuery.trim() && (
                <div className="absolute top-full left-0 mt-2 w-[420px] bg-white border border-gray-200 rounded-xl shadow-xl z-50 max-h-80 overflow-y-auto">
